...
## Magisk Module for Qualqomm Snapdragon Only 
...
2. Download the `.zip` file from the [latest release](https://github.com/GotenAjje/Termox/releases)  
...
This project is released under the [License](https://github.com/GotenAjje/Termox/blob/main/LICENSE)
